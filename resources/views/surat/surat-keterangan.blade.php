                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Surat Keterangan</h4>
                                @include('breadcrumb')
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>Surat Keterangan</b></h4>
...
@section('script')
    ...
    <!-- Examples -->
    {{-- <script src="{{ url('plugins/mag/nific-popup/js/jquery.magnific-popup.min.js') }}"></script> --}}
