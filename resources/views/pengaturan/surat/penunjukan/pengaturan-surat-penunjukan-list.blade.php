                    ...
                    <div class="col-md-12">
                        <div class="card-box table-responsive">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="m-b-30">
                                        <a href="{{ url('superadmin/pengaturan/surat/penunjukan/tambah') }}"
                                    ...
                                    @foreach ($pengaturan as $key => $item)
                                        <tr class="">
                                            ...
                                            <td class="actions text-center">
                                                ...
                                                <a href="{{ url("superadmin/pengaturan/surat/penunjukan/$item->pengaturan_surat_penunjukan_id/lihat") }}"
                                                    target="_blank" class="btn btn-primary btn-action text-white">
                                                    <i class="fa fa-eye text-white"></i> Lihat contoh
                                                </a>
                                                <a href="{{ url("superadmin/pengaturan/surat/penunjukan/$item->pengaturan_surat_penunjukan_id/edit") }}"
                                                    class="btn btn-warning btn-action text-white">
                                                    <i class="fa fa-pencil text-white"></i> {{ editText() }}
                                                </a>
                                                <a href="{{ url("superadmin/pengaturan/surat/penunjukan/$item->pengaturan_surat_penunjukan_id/hapus", []) }}"
