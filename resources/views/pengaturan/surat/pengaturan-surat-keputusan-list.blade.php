                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box table-responsive">
                            {{-- ModalSample --}}
                            <div id="modalPengaturanSurat" class="modal fade" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form id="formBody" method="POST"
                                            action="{{ url('/superadmin/pengaturan/surat/keputusan') }}">
                                            @csrf
                                ...
                                <div class="col-sm-6">
                                    <div class="m-b-30">
                                        <button id="tambahBody" class="btn btn-success waves-effect waves-light"
                                            data-toggle="modal" data-target="#modalPengaturanSurat">
                                    ...
                                    @foreach ($body as $key => $item)
                                        <tr class="">
                                            ...
                                            <td class="actions text-center">
                                                ...
                                                <button href="" data-toggle="modal" data-target="#modalPengaturanSurat"
