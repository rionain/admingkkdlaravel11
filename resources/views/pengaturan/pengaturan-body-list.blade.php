                    ...
                    <div class="col-md-12">
                        <div class="card-box table-responsive">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="m-b-30">
                                        <button id="tambahBody" class="btn btn-success waves-effect waves-light" data-toggle="modal"  data-target="#bodySuratModal">
                                        ...
                                        <tr class="">
                                            ...
                                            <td class="actions text-center">
                                                {{-- <div class="btn-group btn-group-justified m-b-10 text-center"> --}}
                                                    <button href="" data-toggle="modal" data-target="#bodySuratModal" onclick="editBody('{{ $item->template_body_id }}')" title="Edit Body Surat" class="btn btn-warning btn-action text-white">
                                                        <i class="fa fa-pencil text-white"></i> {{editText()}}
                                                    </button>
                                                    <button href="#" onclick="delConf('{{ url('superadmin/administrasi/pengaturan/body-surat/hapus/' . $item->template_body_id, []) }}')" class="btn btn-danger waves-effect waves-light btn-action">
