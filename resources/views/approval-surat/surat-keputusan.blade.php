                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Approval Surat Keputusan</h4>
                            @include('breadcrumb')
                                            ...
                                            <tr class="">
                                                ...
                                                <td class="actions">
                                                    <button class="btn btn-primary" style="margin-bottom: 5px;"
                                                        onclick="window.open('{{ url('approval/approve-surat/surat-keputusan/lihat/' . $item->surat_keputusan_id, []) }}', 'newwindow', 'width=1000,height=700,left=450'); return;">
                                                        <i class="fa fa-eye"></i>
                                                        Lihat</button>
                                                    <a href="#" data-toggle="modal" data-target="#modalDemote"
                                                        class="on-default"
                                                        onclick="demote('{{ $item->surat_keputusan_id }}')"><i
                                                            class="fa fa-times"></i></a>
                                                    <a href="{{ url('approval/approve-surat/surat-keputusan/approve/' . $item->surat_keputusan_id, []) }}"
                                                        class="on-default"
    ...
    <script>
        ...
        function demote(id) {
            titleActionSurat('Demote surat', base_url(
                'approval/approve-surat/surat-keputusan/demote/' + id))
            startloading('#' + modalSurat + ' .modal-dialog')

            var settings = {
                'url': base_url('api/v1/approval/approve-surat/surat-keputusan/' + id),
                'method': 'GET',
                'dataType': 'json',
                'timeout': timeOut()
            };
