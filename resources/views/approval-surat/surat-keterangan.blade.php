                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Approval Surat Keterangan</h4>
                            @include('breadcrumb')
                                            ...
                                            <tr class="">
                                                ...
                                                <td class="actions">
                                                    <button class="btn btn-primary" style="margin-bottom: 5px;"
                                                        onclick="window.open('{{ url('approval/approve-surat/lihat/' . $item->surat_id, []) }}', 'newwindow', 'width=1000,height=700,left=450'); return;">
                                                        <i class="fa fa-eye"></i>
                                                        Lihat</button>
