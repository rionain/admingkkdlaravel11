            ...
            <div class="container">
                ...
                <div class="panel">
                    <div class="panel-body text-center">
                        <h3>Lihat Contoh Surat</h3>
                        <a href="{{ url('superadmin/administrasi/sertifikat/pengaturan/sertifikat-pernikahan/print-view?jenis=pemberkatan') }}"
                            target="_blank" class="btn btn-success">Lihat Contoh Sertifikat Pemberkatan Nikah</a>
                        <a href="{{ url('superadmin/administrasi/sertifikat/pengaturan/sertifikat-pernikahan/print-view?jenis=peneguhan') }}"
                            target="_blank" class="btn btn-success">Lihat Contoh Sertifikat Peneguhan Nikah</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="modalPengaturanSertifikat" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ url('superadmin/administrasi/sertifikat/pengaturan/sertifikat-pernikahan') }}"
