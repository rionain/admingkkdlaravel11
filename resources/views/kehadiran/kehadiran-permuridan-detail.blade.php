            ...
            <div class="container">
                ...
                <div class="panel">
                    <div class="panel-body">
                        <a href="{{ url('superadmin/kehadiran/permuridan') }}" class="btn btn-success"><i
                        ...
                        <div id="kehadiranPermuridanDetail" class="modal fade" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form
                                        action="{{ url("superadmin/kehadiran/permuridan/$permuridan->permuridan_id/detail") }}"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($kehadiran as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a
                                                    onclick='confirmAlert(`warning`,`Apakah anda yakin ingin mengganti flag kehadiran?`,`{{ url("superadmin/kehadiran/permuridan/$permuridan->permuridan_id/detail/$value->permuridan_detail_id/ganti-flag-hadir") }}`,`Ya`)'>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{ url("superadmin/kehadiran/permuridan/$permuridan->permuridan_id/detail/$value->permuridan_detail_id/hapus") }}"
