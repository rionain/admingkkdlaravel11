                            ...
                            <div id="kehadiranPermuridan" class="modal fade" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ url('/superadmin/kehadiran/permuridan') }}" method="POST"
                                ...
                                <tbody>
                                    @foreach ($kehadiran as $key => $value)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ url("superadmin/kehadiran/permuridan/$value->permuridan_id/detail") }}"
                                                ...
                                                <a href="#" class="btn btn-danger btn-action"
                                                    onclick="delConf('{{ url('superadmin/kehadiran/permuridan/' . $value->permuridan_id . '/hapus') }}')"><i
...
@section('script')
    ...
    <script>
        ...
        function showAnakPA() {
            ...
            $.ajax({
                type: "GET",
                url: `{{ url('api/v1/superadmin/kehadiran/permuridan/get-user') }}?kelompok=${kelompok}`,
                dataType: "JSON",
    ...
    <script>
        ...
        $('#tambahPermuridan').on('click', function() {
            titleAction('Form Tambah', base_url(
                'superadmin/kehadiran/permuridan'))
        });
        ...
        function editKehadiranPermuridan(id) {
            titleAction('Edit Bahan', base_url('superadmin/kehadiran/permuridan/' + id))
            startloading('#' + kehadiranPermuridan + ' .modal-dialog')
            var settings = {
                'url': base_url('api/v1/superadmin/kehadiran/permuridan/' + id),
                'method': 'GET',
                'dataType': 'json',
                'timeout': timeOut()
            };
