                ...
                <div class="row">
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <div id="modalAnakPA" class="modal fade" role="dialog" aria-labelledby="myModalLabel"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ url('superadmin/administrasi/anak-pa') }}" method="POST"
                                            enctype="multipart/form-data" id="formAnakPA">
                                            @csrf
                                            <input type="hidden" name="lfk_cabang_id"
                                                value="{{ $kakak_pa->lfk_cabang_id }}">
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label for="nama" class="control-label">Nama
                                                        Anak PA</label>
                                                    <input type="text" class="form-control" name="nama" id="nama"
                                                        placeholder="Nama anak PA" required value="{{ old('nama') }}">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="tel" class="form-control" name="phone" id="phone"
                                                        placeholder="085....." required value="{{ old('phone') }}">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label for="kelompok_pa" class="control-label">Kelompok
                                                                PA</label>
                                                        </div>
                            ...
                            <a href="{{ url('superadmin/database/database-permuridan?tab=kakak_pa') }}"
                                class="btn btn-success"><i class="fa fa-arrow-left"></i> Kembali</a>
                            ...
                            <table class="table table-bordered table-striped" style="max-width: 50%;margin-top: 20px">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ @$kakak_pa->cabang->kategori_gereja->kategori_gereja }}</td>
                                    </tr>
                                    <tr>
                                        <th>Nama Gereja</th>
                                        <td>{{ @$kakak_pa->cabang->nama_cabang }}</td>
                                    </tr>
                                </thead>
                                <tbody>
                            ...
                            <div class="m-b-30">
                                <button id="addAnakPA" type="button" class="btn btn-success waves-effect waves-light"
                                    data-toggle="modal" data-target="#modalAnakPA"
                                    onclick="tambah('{{ $kakak_pa->user_id }}')">Add <em
                                ...
                                <table class="table table-striped add-edit-table table-bordered" id="datatable-anak-pa">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Anak PA</th>
                                        ...
                                        @foreach ($anak_pa as $key => $value)
                                            <tr>
                                                ...
                                                <td class="actions text-center">
                                                    ...
                                                    <a href="{{ url("superadmin/database/database-permuridan/kakak-pa/$kakak_pa->user_id/anak-pa/$value->user_id/hapus", []) }}"
    ...
    <script>
        ...
        function editAnakPA(kakak_pa_id, anak_pa_id) {
            titleActionAnakPA('Edit Anak PA', base_url(
                `superadmin/database/database-permuridan/kakak-pa/${kakak_pa_id}/anak-pa/${anak_pa_id}`))
            startloading('#' + addAnakPAData + ' .modal-dialog')
            var settings = {
                'url': base_url('api/v1/superadmin/database/database-permuridan/anak-pa/' + anak_pa_id),
                'method': 'GET',
                'dataType': 'json',
                'timeout': timeOut()
            };
        ...
        function tambah(kakak_pa_id) {
            titleActionAnakPA('Form Tambah Anak PA', base_url(
                `superadmin/database/database-permuridan/kakak-pa/${kakak_pa_id}/anak-pa`));
        }
        ...
        $(document).ready(function() {
            ...
            $(`#${addAnakPAData} #lfk_cabang_id`).chained(`#${addAnakPAData} #lfk_cabang_id`);
            $(`#${addAnakPAData} #kelompok_pa`).chained(`#${addAnakPAData} #lfk_cabang_id`);
