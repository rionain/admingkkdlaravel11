...
class KehadiranPermuridanController extends Controller
{
    public function permuridan()
    {
        ...
        $where = ['permuridan_header.deleted' => '0'];
        ...
        $data = [
            ...
            'kelompok'          => KelompokPA::where(['active' => 1, 'deleted' => '0'])->get(),
        ...
        return view('kehadiran.kehadiran-permuridan', $data);
    }
    ...
    public function tambah_permuridan()
    {
        ...
        try {
            ...
            $permuridan->lfk_cabang_id          = $value->lfk_cabang_id;
            $permuridan->active                     = 1;
    ...
    public function permuridan_detail($permuridan_id)
    {
        ...
        // return $data['kehadiran'];
        return view('kehadiran.kehadiran-permuridan-detail', $data);
    }
