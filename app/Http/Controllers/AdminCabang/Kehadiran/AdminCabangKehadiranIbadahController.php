...
class AdminCabangKehadiranIbadahController extends Controller
{
    public function ibadah()
    {
        ...
        $data = [
            ...
            'kehadiran'         => IbadahDetail::where($where)
                ...
                ->where('ibadah_header.lfk_cabang_id', $subcabangid)
                ->orderBy('ibadah_detail.created_date', 'DESC')->get(),
            'ibadah'            => Ibadah::where(['active' => 1, 'deleted' => '0', 'lfk_cabang_id' => $subcabangid])->get(),
        ...
        return view('admin-cabang.kehadiran.kehadiran-ibadah', $data);
    }
    ...
    public function hapus_ibadah($ibadah_detail_id = null)
    {
        ...
        $tanda_tangan = IbadahDetail::where('ibadah_detail_id', $ibadah_detail_id)->where(['deleted' => '0'])->orderBy('created_date', 'DESC')->first();
        if (!$tanda_tangan) {
            return redirect()->back()->withInput()->with('gagal', 'Data tidak ditemukan');
        }
