...
class SuratKeputusan extends Model
{
    ...
    public function pengaturan_surat_keputusan()
    {
        return $this->belongsTo(PengaturanSuratKeputusan::class, 'pengaturan_surat_keputusan_id', 'pengaturan_surat_keputusan_id');
    }
}
